...
//     router.replace('/addCourse/addcoursepage');
//   } catch (error) {
...
//     Alert.alert(
//       'Payment Required',
//       `You selected the ${selectedPlan} plan (${PRICING[selectedPlan][selectedBilling]}). Do you want to proceed with payment?`,
//       [
//         {
//           text: 'Cancel',
//           style: 'cancel',
//           onPress: () => {
//             Alert.alert('Info', 'Switching to Free plan.');
...
//           text: 'Pay & Continue',
//           onPress: async () => {
//             // Simulated payment success – replace with real gateway integration later
